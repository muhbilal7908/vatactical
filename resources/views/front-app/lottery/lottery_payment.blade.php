            ...
            <article class="post_item post_item_single">
                <section class="post_content">
                    <div class="woocommerce">
                        ...
                        <form id="lottery-payment-form" action="{{route('lottery-store-payment',['id'=>$data->id])}}" method="POST">
                            ...
                            <input type="hidden" name="sub_total"  value="{{$shipping['sub_total']}}">
                                    ...
                                    <div class="woocommerce-shipping-fields">
                                                ...
                                                <div id="order_review" class="woocommerce-checkout-review-order">
                                                    <table class="shop_table woocommerce-checkout-review-order-table">
                                                        <thead>
                                                            <tr>
                                                                <th class="product-name">Lottery</th>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr class="cart_item">
                                                                <th class="text-white">Tickets: {{$shipping['quantity']}}</th>
                                                                <td class="product-total">
                                                                    <span class="woocommerce-Price-amount amount text-white">
                                                                        <span class="woocommerce-Price-currencySymbol ">&#36;</span><span id="end_price_text">@php  echo    $data->price * $shipping['quantity'] @endphp</span>
                                                                    </span>
                                                                </td>
                                                            </tr>
                                                    ...
                                                    <table class="shop_table woocommerce-checkout-review-order-table">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><a class="rounded-3 bg-success" style="padding:10px 20px!important;cursor: pointer;" onclick="getPromo()">Apply Code</td>
                                                        </tr>
                                                        <tr>
...
$('#lottery-payment-form').submit(function(event) {
    ...
    // Send AJAX request
    $.ajax({
        url: "{{route('lottery-store-payment',['id'=>$data->id])}}", // Your form action URL
        type: "POST",
        data: formData,
