...
<div class="top_panel_title top_panel_style_1 title_present breadcrumbs_present scheme_original">
    <div class="top_panel_title_inner ">
        <div class="content_wrap">
            <h1 class="page_title">Lottery Checkout</h1>
            <div class="breadcrumbs">
                <a class="breadcrumbs_item home" href="{{route('home')}}">Home</a>
                <span class="breadcrumbs_delimiter"></span>
                <a class="breadcrumbs_item all" href="{{route('all-lottery')}}">Lottery</a>
                <span class="breadcrumbs_delimiter"></span>
                <span class="breadcrumbs_item current">Lottery Checkout</span>
            </div>
        </div>
    </div>
</div>
            ...
            <article class="post_item post_item_single">
                <section class="post_content">
                    <div class="woocommerce">
                        ...
                        <form action="{{route('lottery-payment',['slug'=>$data->slug])}}" method="GET">
                            @csrf
                            <div class="col2-set" id="customer_details">
                                ...
                                <div class="col-2">
                                    ...
                                    <h5 id="order_review_heading text-center">Lottery Summary</h5>
                                                <div id="order_review" class="woocommerce-checkout-review-order">
                                                    <table class="shop_table woocommerce-checkout-review-order-table">
                                                        ...
                                                        <tbody>
                                                            <tfoot>
                                                                <tr >
                                                                    <th class="text-white">Lottery Price</th>
                                                                ...
                                                                <tr >
                                                                    <th class="text-white">Lottery Tickets</th>
                                                                    <td class="product-total">
                                                                        <span class="woocommerce-Price-amount amount">
                                                                            <span class="woocommerce-Price-currencySymbol text-white">
                                                                             {{$quantity}}
                                                                        </span>
                                                                        <input type="hidden" value="{{$data->price}}" name="sub_total">
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <th class="text-white">Lottery Gift :

                                                                    </th>
                                                                    <td>
                                                                        <img src="{{asset('assets/lottery/'.$data->img)}}" style="widows: 40px;height:40px;" alt="">
