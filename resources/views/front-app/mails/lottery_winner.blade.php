    ...
    <div >
        ...
        <div class="container" style="padding: 20px">
            <div class="row text-center" style="text-align:center;">
                <p class="text-white">Congratulations on Winning the Lottery!</p>
                <p class="text-white">Hi, {{$order->first_name}}</p>
                <p>Your Lottery Ticket #{{ $order->id }} has won! We're thrilled to inform you that you're a lucky winner.</p>
                <p>We'll be reaching out to you via email shortly to provide more details on claiming your prize.</p>
            </div>
        </div>
        {{-- <div class="container" style="padding:20px;">
            <div class="row">
