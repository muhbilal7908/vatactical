...
<div class="top_panel_title top_panel_style_1 title_present breadcrumbs_present scheme_original">
    <div class="top_panel_title_inner ">
        <div class="content_wrap">
            <h1 class="page_title ">SHIPPING ADDRESS / <span style="color:#728080;">Payment / Confirmation</span></h1>
            <div class="breadcrumbs ">
                <a class="breadcrumbs_item home" href="{{route('home')}}">Home</a>
                <span class="breadcrumbs_delimiter"></span>
                <a class="brea  dcrumbs_item all" href="{{route('shop')}}">Shop</a>
                <span class="breadcrumbs_delimiter"></span>
                                ...
                                <div class="col-1">
                                    <div class="">
                                        ...
                                        <div class="woocommerce-billing-fields__field-wrapper">
                                            ...
                                            <p class="form-row form-row-last validate-validate-email w-100" id="billing_email_field" >
                                                <label for="billing_email" class="">Shipping Method
                                                    <abbr class="required" title="required">*</abbr>
                                                </label>
                                                <div class="row position-relative">
                                                    <div class="form-check">
                                                        <input class="form-check-input ship_method"  value="instore" type="radio" name="shipping" id="flexRadioDefault1" checked>
                                                        <label class="form-check-label" for="flexRadioDefault1">
                                                          In Store Pickup
                                                        </label>
                                                      </div>
                                                      <div class="form-check">
                                                        <input class="form-check-input ship_method" value="delivery" type="radio" name="shipping" id="flexRadioDefault2" >
                                                ...
                                                <div id="order_review" class="woocommerce-checkout-review-order">
                                                    <table class="shop_table woocommerce-checkout-review-order-table">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            @empty
                                                                <tr>
                                                                    <td colspan="2">No items found in the cart.</td>
                                                                </tr>
                                                            @endforelse
                                                        </tbody>
                                                        ...
                                                        <tfoot>
                                                            @php
                                                                ...
                                                                foreach ($data as $key => $item) {
                                                                    ...
                                                                    if ($subscription) {
                                                                        foreach ($categories as $value) {
                                                                            if ($value->slug === 'firearms') {
                                                                                $discount = $subscription->membership->firearms;  
                                                                            }
                                                                            if ($value->slug === 'ammunition') {
                                                                                $discount = $subscription->membership->ammunition;    
                                                                            }
                                                                            if ($value->slug === 'accessories') {
                                                                                $discount = $subscription->membership->accessories;    
                                                                            }
                                                                        }
                                                                    }
                                                                    
                                                                    // Calculate item price and discount
                                                                    $item_price = $item->sub_total * $item->quantity;
                                                                    $item_discount_amount = 0;
                                                                    
                                                                    if ($discount > 0) {
                                                                        $item_discount_amount = $item_price * ($discount / 100);
                                                                ...
                                                                $sales_tax_percentage = floatval($shipping->sales_tax);
                                                                $sales_tax = $total_price * ($sales_tax_percentage / 100);
                                                                $total_price_with_tax = $total_price + $sales_tax;
                                                            @endphp
                                                        
                                                            <tr>
                                                                <th class="text-white">Sales Tax ({{$shipping->sales_tax}}%)</th>
                                                                <td class="text-white">${{ number_format($sales_tax, 2) }}</td>
                                                            </tr>
                                                            ...
                                                            <tr class="cart-subtotal">
                                                                ...
                                                                <td>
                                                                    <span class="woocommerce-Price-amount amount text-white">
                                                                        <span class="woocommerce-Price-currencySymbol text-white">&#36;</span>{{ number_format($total_price_with_tax, 2) }}
                                                                    </span>
                                                                </td>
                                                            </tr>
                                                        
                                                            <tr class="cart-discount">
                                                                <th class="text-white">Membership Discount</th>
                                                                <td>
                                                                    <span class="woocommerce-Price-amount amount text-white">
                                                                        <span class="woocommerce-Price-currencySymbol text-white">&#36;</span>{{ number_format($total_discount_amount, 2) }}
                                                                    </span>
                                                                </td>
                                                            </tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-white">$<span id="shipping_price_text">0</span></td>
                                                            </tr>
                                                            ...
                                                            <tr class="order-total text-white">
                                                                ...
                                                                <td>
                                                                    <strong>
                                                                        <span class="woocommerce-Price-amount amount text-white">
                                                                            <span class="woocommerce-Price-currencySymbol text-white">&#36;</span><span id="end_price_text">{{ $total_price_with_tax - $total_discount_amount }}</span>
                                                                            <input type="hidden" name="sub_total" id="end_price" value="{{ $total_price_with_tax - $total_discount_amount }}">
                                                                        </span>
                                                                    </strong>
                                                                </td>
                                                            </tr>
...
$('input.ship_method').change(function() {
  // Retrieve the value of the selected radio button
  var selectedValue = $(this).val();

  // Conditionally update shipping price and final price
  var shipping_price = selectedValue === 'delivery' ? {{ $shipping->shipping_price }} : 0;
  var end_price = parseFloat($("#end_price").val()); // Parse to number for calculation
  var max_val = {{$total_price_with_tax}} + shipping_price;

  // Update displayed elements
  $("#end_price").val(max_val); // Format and set end price value
  $("#end_price_text").text(max_val); // Format and display end price
  $("#shipping_price_text").text(shipping_price); // Update shipping price text (optional)
