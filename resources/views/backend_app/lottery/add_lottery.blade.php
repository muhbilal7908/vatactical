                    ...
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item">Add Lottery
                                </li>
                            </ol>
                        </div>
                    </div>
                </div>
                <form action="{{route('store-lottery')}}" method="POST" enctype="multipart/form-data">
                    @csrf
            </div>
                    ...
                    <div class="card">
                        ...
                        <div class="row p-3">
                            ...
                            <div class="col-12 mt-1">
                                ...
                                <input type="date" name="date" class="form-control" placeholder="Enter Instagram">
                                @error('date')
                                    <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
                            ...
                            <div class="col-12 mt-1">
                                ...
                                <input type="number" name="discount_price" class="form-control" placeholder="Enter Discount Price For Multiple Tickets">
                            ...
                            <div class="col-12 mt-1">
                                ...
                                <textarea  id="" cols="30" rows="10" name="description" class="form-control textarea" placeholder="Enter Description"></textarea>
                            </div>
                        </div>
                                                  ...
                                                  <div class="tab-content" id="myTabContent">
                                                    ...
                                                    <div class="tab-pane fade p-1" id="profile-tab-pane" role="tabpanel" aria-labelledby="profile-tab" tabindex="0">
                                                        ...
                                                        <select name="gift_card_id" id="" class="form-control">
                                                            <option value="">Choose...</option>
                                                            <!-- Assuming $giftcards is an array of gift cards -->
                                                    ...
                                                    <div class="tab-pane fade p-1" id="contact-tab-pane" role="tabpanel" aria-labelledby="contact-tab" tabindex="0">
                                                        ...
                                                        <select name="course_id" id="" class="form-control">
                                                            <option value="">Choose...</option>
                                                            <!-- Assuming $courses is an array of courses -->
