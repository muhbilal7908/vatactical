            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-0">Membership</h2>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a>
                                    </li>
                                    <li class="breadcrumb-item">Membership Detail
                                    </li>
                                </ol>
                            </div>
                        </div>
                            ...
                            <div class="col-8  ">
                                ...
                                <table class="table border bg-white ">
                                    ...
                                    <tbody>
                                            ...
                                            <tr >
                                                <td>
                                                    <img width="70" class=" rounded-3 me-2" src="{{ asset('assets/gift_cards/' . ($data->membership ? $data->membership->img : 'N/A')) }}">
                                                </td>
                                                
                                                <td>{{ $data->membership ? $data->membership->name  : "N/A"}}</td>
                            ...
                            <div class="col-4">
                                ...
                                <th>More</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$data->promocode != null ? $data->promocode : "Not Applied"}}%</td>
                                    </tr>
                                    <tr>
                                        <td>Total</td>
                                        <td>${{ $data->total }}</td>
