...
<script src="{{asset('backend/vendors/js/editors/quill/katex.min.js')}}"></script>
<script src="{{asset('backend/vendors/js/editors/quill/highlight.min.js')}}"></script>
<script src="{{asset('backend/vendors/js/editors/quill/quill.min.js')}}"></script>
