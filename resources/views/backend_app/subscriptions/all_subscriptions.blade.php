            ...
            <div class="row">
                <div class="col-12">
                    <div class="card p-2">
                        ...
                        <form action="{{route('filter-subscription')}}" method="GET">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="d-flex flex-row flex-between w-100">
                            ...
                            <a href="{{route('generate-pdf-subscriptions')}}" class="btn btn-primary mb-2 mt-1 ms-auto waves-effect waves-float waves-light"  id="export_pdf" class="btn text-success  ms-auto ">Export PDF <i data-feather="file-text"></i></a>
                        </div>
