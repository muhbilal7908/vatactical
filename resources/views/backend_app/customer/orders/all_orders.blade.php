            ...
            <div class="row">
                <div class="col-12">
                    <div class="card p-2">
                        ...
                        <form action="{{route('customer-filter-order')}}" method="post">
                            @csrf
                        <div class="row">
                            ...
                            <div class="col-4">
                               <button type="submit" class="btn btn-primary mt-2 ms-auto d-block">Show Data</button>
                            </div>
                        </form>
                        </div>
                    </div>
                            ...
                            <table class="table" style="font-size: 10px;">
                                ...
                                <tbody>
                                    ...
                                    <tr style="width:100px;">
                                        ...
                                        <td>
                                            <span class=" @if($item->delivery_status === 'pending') text-danger @endif @if($item->delivery_status === "delivered") text-success @endif fw-bold" id="">
