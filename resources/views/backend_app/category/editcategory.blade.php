                    ...
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item">Update Category / {{$data->name}}
                                </li>
                            </ol>
                        </div>
                    </div>
                            ...
                            <div class="col-12 mt-1">
                               ...
                               <select name="sub_category" class="form-select" id="">
                                ...
                                @forelse ($category as $item)
                                    ...
                                    @else
                                    <option @if($data->subcategories->name === $item->name) selected @endif   value="{{$item->id}}">{{$item->name}}</option>
                                    @endif
                                @empty
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="row p-2">
                                            <div class="col-12">
                                                ...
                                                <img src="{{asset('assets/'.$data->img)}}" class="w-100" alt="">
