                    ...
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item">All Blogs
                                </li>
                            </ol>
                        </div>
                    </div>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{$key}}</td>
                                        <td>
                                            <img src="{{asset('assets/blogs/'.$item->img)}}" class="me-1 rounded-3" width="60" alt="blog" />
                                            {{$item->name}}
                                        </td>
                                        ...
                                        <td>
                                            <div class="form-check form-switch">
                                                ...
                                                <input value="1" onclick="updateFeaturedStatus(this)" class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckDefault" {{ $item->featured ? 'checked' : '' }}>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    <a class="dropdown-item" href="{{route('edit-blog', ['id' => $item->id]) }}">

                                                        <i data-feather="edit-2" class="me-50"></i>
                                                        <span>Edit</span>
                                                    </a>
                                                    <a class="dropdown-item" href="{{route('destroy-blog',['id'=>$item->id])}}">
