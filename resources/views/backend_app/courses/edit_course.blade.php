...
<div class="app-content content ">
    ...
    <div class="content-wrapper container-xxl p-0">
                    ...
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item">Update Course
                                </li>
                            </ol>
                        </div>
                    </div>
        ...
        <div class="row">
            <div class="col-lg-9 col-sm-12 col-md-6 col-xl-9">
                    ...
                    <div class="card">
                        ...
                        <div class="row p-3">
                            ...
                            <div class="col-12 mt-1">
                               ...
                               <input type="text" name="video_link" class="form-control" value="{{$data->video}}" placeholder="Video Link">
                                @error('video_link')
                                <span class="text-danger">{{$message}}</span>
                            @enderror
                            </div>
