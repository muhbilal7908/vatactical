...
var FullCalendar = (function (e) {
    ...
    function Qt(e, t, n, r) {
        ...
        return { date: o, start: o, end: t ? Jt(t, n.calendarSystem) : null, timeZone: n.timeZone, localeCodes: n.locale.codes, defaultSeparator: r || n.defaultSeparator };
    }
    var en = (function () {
            function e(e) {
                this.cmdStr = e;
    ...
    var cn = { type: String, component: fn, buttonText: String, buttonTextKey: String, dateProfileGeneratorClass: fn, usesMinMaxTime: Boolean, classNames: fn, content: fn, didMount: fn, willUnmount: fn };
    function dn(e) {
        return ht(e, ln);
    }
    function pn(e, t) {
    ...
    var Dn = {
        ...
        bn = { display: null, startEditable: null, durationEditable: null, constraints: [], overlap: null, allows: [], backgroundColor: "", borderColor: "", textColor: "", classNames: [] };
    function Cn(e, t) {
        var n = (function (e, t) {
    ...
    function Er(e, t, n) {
        var r;
        if ((void 0 === n && (n = Sr(t)), "string" == typeof e ? (r = { url: e }) : "function" == typeof e || Array.isArray(e) ? (r = { events: e }) : "object" == typeof e && e && (r = e), r)) {
            var o = pn(r, n),
                i = o.refined,
                a = o.extra,
                s = (function (e, t) {
            ...
            return (
                ...
                (e.prototype.addEvent = function (e, t) {
                    if (e instanceof Cr) {
                        var n = e._def,
                            r = e._instance;
                        return this.getCurrentData().eventStore.defs[n.defId] || (this.dispatch({ type: "ADD_EVENTS", eventStore: vn({ def: n, instance: r }) }), this.triggerEventAdd(e)), e;
                    }
                    var o,
                ...
                (e.prototype.mutate = function (t) {
                    ...
                    if (n) {
                        var r = this._def,
                            ...
                            a = gn(i, n.instanceId);
                        a = hr(a, { "": { display: "", startEditable: !0, durationEditable: !0, constraints: [], overlap: null, allows: [], backgroundColor: "", borderColor: "", textColor: "", classNames: [] } }, t, o);
                        var s = new e(o, r, n);
    ...
    var Ir = (function () {
            ...
            return (
                ...
                (e.prototype.createMarkerMeta = function (e) {
                    ...
                    var t = null;
                    return (
                        "number" == typeof e ? (t = this.timestampToMarker(e)) : e instanceof Date ? ((e = e.valueOf()), isNaN(e) || (t = this.timestampToMarker(e))) : Array.isArray(e) && (t = ut(e)),
    ...
    if (((vo.prototype.classes = {}), (vo.prototype.iconClasses = {}), (vo.prototype.baseIconClass = ""), (vo.prototype.iconOverridePrefix = ""), "undefined" == typeof FullCalendarVDom))
    ...
    (Ao.prototype.classes = { root: "fc-theme-standard", tableCellShaded: "fc-cell-shaded", buttonGroup: "fc-button-group", button: "fc-button fc-button-primary", buttonActive: "fc-button-active" }),
        (Ao.prototype.baseIconClass = "fc-icon"),
        (Ao.prototype.iconClasses = { close: "fc-icon-x", prev: "fc-icon-chevron-left", next: "fc-icon-chevron-right", prevYear: "fc-icon-chevrons-left", nextYear: "fc-icon-chevrons-right" }),
        (Ao.prototype.rtlIconClasses = { prev: "fc-icon-chevron-right", next: "fc-icon-chevron-left", prevYear: "fc-icon-chevrons-right", nextYear: "fc-icon-chevrons-left" }),
                ...
                (o = function (e) {
                    return mo(_o.Consumer, null, function (n) {
                        return mo(qo, { viewSpec: n.viewSpec }, function (o, i) {
                            ...
                            return mo(Lo, { hookProps: a, classNames: t.classNames, content: t.content, didMount: t.didMount, willUnmount: t.willUnmount, elRef: o }, function (e, t, n, r) {
    ...
    var $o = (function () {
        ...
        return (
            ...
            (e.prototype.buildRangeFromDuration = function (e, t, n, r) {
                ...
                return Pt(n) <= 1 && this.isHiddenDay(o) && (o = rt((o = this.skipHiddenDays(o, t)))), d(), this.trimHiddenDays(a) || ((e = this.skipHiddenDays(e, t)), d()), a;
            }),
    ...
    function hi(e, t, n, r, o) {
        var i = [];
        return { headerToolbar: e.headerToolbar ? vi(e.headerToolbar, e, t, n, r, o, i) : null, footerToolbar: e.footerToolbar ? vi(e.footerToolbar, e, t, n, r, o, i) : null, viewsWithButtons: i };
    }
        ...
        return (
            ...
            (e.prototype.updateData = function () {
                ...
                if (m && m !== y)
                    for (var E in (m.timeZone !== y.timeZone &&
                        ((d.eventSources = v.eventSources = ((a = v.eventSources), (s = d.dateProfile), (l = v), (u = s ? s.activeRange : null), ri(a, ii(a, l), u, !0, l))),
            ...
            (e.prototype.processRawCalendarOptions = function (e, t) {
                var n = dn([on, e, t]),
                    ...
                    g = !1;
                for (var m in p) "plugins" !== m && (p[m] === h[m] || (ln[m] && m in h && ln[m](h[m], p[m])) ? (f[m] = v[m]) : c[m] ? ((f[m] = c[m](p[m])), (g = !0)) : (d[m] = h[m]));
                return (
            ...
            return (
                ...
                (e.prototype.splitEntry = function (e, t, n) {
                    ...
                    return (
                        ...
                        i ? (n.push.apply(n, o([r(r({}, e), { spanStart: Math.max(t.spanStart, e.spanStart), spanEnd: Math.min(t.spanEnd, e.spanEnd) })], a)), i) : (n.push(e), 0)
                    );
                }),
                (e.prototype.insertEntryAt = function (e, t) {
                    var n = t.nextLevel;
                    !n || this.levelCoords[n - 1] < t.levelCoord ? (zi(this.levelCoords, n, t.levelCoord), zi(this.entriesByLevel, n, [e])) : zi(this.entriesByLevel[n - 1], t.lateralEnd, e), (this.stackCnts[Vi(e)] = t.stackCnt);
                }),
                (e.prototype.findInsertion = function (e) {
                    ...
                    for (t = 0; t < l && ((n = o[t]), s || !(n >= d + e.thickness)); t += 1) {
                        ...
                        for (c = u = v[0] + v[1]; (h = f[c]) && h.spanStart < e.spanEnd; ) (s || (d < n + h.thickness && d + e.thickness > n)) && ((p = h), (d = n + h.thickness)), (c += 1);
                    }
    ...
    function Fi(e) {
        for (var t = [], n = 0, r = e; n < r.length; n++) {
            for (var o = r[n], i = [], a = { spanStart: o.spanStart, spanEnd: o.spanEnd, entries: [o] }, s = 0, l = t; s < l.length; s++) {
                var u = l[s];
                u.spanStart < a.spanEnd && u.spanEnd > a.spanStart ? (a = { spanStart: Math.min(u.spanStart, a.spanStart), spanEnd: Math.max(u.spanEnd, a.spanEnd), entries: u.entries.concat(a.entries) }) : i.push(u);
            }
            i.push(a), (t = i);
        }
        return t;
            ...
            return (
                ...
                (t.prototype.render = function () {
                    ...
                    return (
                        ...
                        mo("div", { className: [o || "", "fc-toolbar", i ? "fc-toolbar-ltr" : ""].join(" ") }, this.renderSection("start", e || []), this.renderSection("center", a || []), this.renderSection("end", t || []))
                    );
                }),
                (t.prototype.renderSection = function (e, t) {
                    var n = this.props;
                    return mo(Ji, { key: e, widgetGroups: t, title: n.title, activeButton: n.activeButton, isTodayEnabled: n.isTodayEnabled, isPrevEnabled: n.isPrevEnabled, isNextEnabled: n.isNextEnabled });
                }),
                t
            );
        })(xo),
                ...
                return (
                    (n.handleSegClick = function (e, t) {
                        ...
                        if (i && r.isValidSegDownEl(e.target)) {
                            ...
                            o.emitter.trigger("eventClick", { el: t, event: new Cr(r.context, i.eventRange.def, i.eventRange.instance), jsEvent: e, view: o.viewApi }), s && !e.defaultPrevented && (window.location.href = s);
                        }
                    }),
            ...
            return (
                ...
                (t.prototype.triggerEvent = function (e, t, n) {
                    var r = this.component,
                        o = r.context,
                        i = Yn(n);
                    (t && !r.isValidSegDownEl(t.target)) || o.emitter.trigger(e, { el: n, event: new Cr(o, i.eventRange.def, i.eventRange.instance), jsEvent: t, view: o.viewApi });
                }),
                t
            );
        })(ji),
    ...
    var ca = (function (e) {
            ...
            return (
                ...
                (t.prototype.render = function () {
                    ...
                    return mo(Lo, { hookProps: f, classNames: n.dayHeaderClassNames, content: n.dayHeaderContent, defaultContent: ua, didMount: n.dayHeaderDidMount, willUnmount: n.dayHeaderWillUnmount }, function (e, t, n, o) {
                        return mo(
                            "th",
                            r({ ref: e, className: c.concat(t).join(" "), "data-date": u.isDisabled ? void 0 : Ut(s), colSpan: a.colSpan }, a.extraDataAttrs),
                            mo("div", { className: "fc-scrollgrid-sync-inner" }, !u.isDisabled && mo("a", r({ ref: n, className: ["fc-col-header-cell-cushion", a.isSticky ? "fc-sticky" : ""].join(" ") }, p), o))
                        );
                    });
                }),
                t
        ...
        da = (function (e) {
            ...
            return (
                ...
                (t.prototype.render = function () {
                    ...
                    return mo(Lo, { hookProps: d, classNames: a.dayHeaderClassNames, content: a.dayHeaderContent, defaultContent: ua, didMount: a.dayHeaderDidMount, willUnmount: a.dayHeaderWillUnmount }, function (t, n, o, i) {
                        return mo(
                            "th",
                            r({ ref: t, className: u.concat(n).join(" "), colSpan: e.colSpan }, e.extraDataAttrs),
                            mo("div", { className: "fc-scrollgrid-sync-inner" }, mo("a", { className: ["fc-col-header-cell-cushion", e.isSticky ? "fc-sticky" : ""].join(" "), ref: o }, i))
                        );
                    });
                }),
                t
            ...
            (t.prototype.render = function () {
                ...
                return mo(pa, { unit: "day" }, function (e, t) {
                    return mo(
                        ...
                        i && i("day"),
                        n.map(function (e) {
                            return o ? mo(ca, { key: e.toISOString(), date: e, dateProfile: r, todayRange: t, colCnt: n.length, dayHeaderFormat: a }) : mo(da, { key: e.getUTCDay(), dow: e.getUTCDay(), dayHeaderFormat: a });
                        })
                    );
                });
            }),
    ...
    function Aa(e, t) {
        for (var n = [], r = 0, i = e; r < i.length; r++) for (var a = i[r], s = a.span || 1, l = 0; l < s; l += 1) n.push(mo("col", { style: { width: "shrink" === a.width ? Ua(t) : a.width || "", minWidth: a.minWidth || "" } }));
    ...
    var ja = (function (e) {
        ...
        return (
            ...
            (t.prototype.renderSection = function (e, t) {
                return "outerContent" in e ? mo(So, { key: e.key }, e.outerContent) : mo("tr", { key: e.key, className: Va(e, this.props.liquid).join(" ") }, this.renderChunkTd(e, t, e.chunk));
            }),
            (t.prototype.renderChunkTd = function (e, t, n) {
                ...
                return mo(
                    ...
                    mo(
                        ...
                        mo(xa, { ref: this.scrollerRefs.createRef(d), elRef: this.scrollerElRefs.createRef(d), overflowY: c, overflowX: r.liquid ? "hidden" : "visible", maxHeight: e.maxHeight, liquid: u, liquidIsAbsolute: !0 }, p)
                    )
                );
            }),
    ...
    var Ga = (function (e) {
            ...
            return (
                ...
                (t.prototype.render = function () {
                    ...
                    return mo(Lo, { hookProps: a, classNames: n.eventClassNames, content: n.eventContent, defaultContent: e.defaultContent, didMount: n.eventDidMount, willUnmount: n.eventWillUnmount, elRef: this.elRef }, function (
                        t,
                        n,
                        r,
                        o
    ...
    var Za = function (e) {
            return mo(_o.Consumer, null, function (t) {
                ...
                return mo(Lo, { hookProps: r, classNames: n.nowIndicatorClassNames, content: n.nowIndicatorContent, didMount: n.nowIndicatorDidMount, willUnmount: n.nowIndicatorWillUnmount }, e.children);
            });
        },
        Xa = nn({ day: "numeric" }),
        Ka = (function (e) {
            ...
            return (
                ...
                (t.prototype.render = function () {
                    var e = this.props,
                        t = this.context,
                        n = t.options,
                        r = $a({ date: e.date, dateProfile: e.dateProfile, todayRange: e.todayRange, showDayNumber: e.showDayNumber, extraProps: e.extraHookProps, viewApi: t.viewApi, dateEnv: t.dateEnv });
    ...
    var es = function (e) {
        return mo(
            Ga,
            { defaultContent: ts, seg: e.seg, timeText: "", disableDragging: !0, disableResizing: !0, isDragging: !1, isResizing: !1, isDateSelecting: !1, isSelected: !1, isPast: e.isPast, isFuture: e.isFuture, isToday: e.isToday },
            function (e, t, n, r, o) {
    ...
    var ns = function (e) {
        return mo(_o.Consumer, null, function (t) {
            var n = t.dateEnv,
                ...
                s = n.format(o, i);
            return mo(Lo, { hookProps: { num: a, text: s, date: o }, classNames: r.weekNumberClassNames, content: r.weekNumberContent, defaultContent: rs, didMount: r.weekNumberDidMount, willUnmount: r.weekNumberWillUnmount }, e.children);
        });
    };
    function rs(e) {
        return e.text;
    ...
    var ys = (function () {
        ...
        ws = (function (e) {
            function t(t, n) {
                ...
                return o.emitter.on("pointerdown", r.onPointerDown), o.emitter.on("pointermove", r.onPointerMove), o.emitter.on("pointerup", r.onPointerUp), n && (o.selector = n), (r.mirror = new ys()), (r.autoScroller = new Cs()), r;
            }
            return (
                n(t, e),
                (t.prototype.destroy = function () {
                ...
                (t.prototype.tryStartDrag = function (e) {
                    this.isDelayEnded &&
                        ...
                        ((this.pointer.wasTouchScroll && !this.touchScrollAllowed) ||
                            ((this.isDragging = !0), (this.mirrorNeedsRevert = !1), this.autoScroller.start(e.pageX, e.pageY), this.emitter.trigger("dragstart", e), !1 === this.touchScrollAllowed && this.pointer.cancelTouchScroll()));
                }),
            ...
            (o.subjectEl = null),
                ...
                (o.handleDragStart = function (e) {
                    ...
                    e.isTouch ? r !== o.component.props.eventSelection && t.dispatch({ type: "SELECT_EVENT", eventInstanceId: r }) : t.dispatch({ type: "UNSELECT_EVENT" }),
                        o.isDragging && (t.calendarApi.unselect(e), t.emitter.trigger("eventDragStart", { el: o.subjectEl, event: new Cr(t, n.def, n.instance), jsEvent: e.origEvent, view: t.viewApi }));
                }),
                        ...
                        if (e) {
                            ...
                            i === a || (d.editable && d.droppable)
                                ? (s = (function (e, t, n) {
                                  ...
                                  ((l = hr(n, a.getCurrentData().eventUiBases, s, a)), (c.mutatedEvents = l), Sa(c, e.dateProfile, a) || ((u = !0), (s = null), (l = null), (c.mutatedEvents = { defs: {}, instances: {} })))
                                : (a = null);
                        }
                        o.displayDrag(a, c),
                            u ? He() : Oe(),
        ...
        function t(t) {
            ...
            (n.draggingSegEl = null),
                ...
                (n.handleDragStart = function (e) {
                    ...
                    (n.draggingSegEl = o), (n.draggingSeg = Yn(o)), t.calendarApi.unselect(), t.emitter.trigger("eventResizeStart", { el: o, event: new Cr(t, r.def, r.instance), jsEvent: e.origEvent, view: t.viewApi });
                }),
                (n.handleHitUpdate = function (e, t, r) {
                    ...
                    l && ((u = hr(i, o.getCurrentData().eventUiBases, l, o)), (d.mutatedEvents = u), Sa(d, e.dateProfile, o) || ((c = !0), (l = null), (u = null), (d.mutatedEvents = null))),
                ...
                (n.handleDragEnd = function (e) {
                    ...
                    if ((t.emitter.trigger("eventResizeStop", { el: n.draggingSegEl, event: a, jsEvent: e.origEvent, view: t.viewApi }), n.validMutation)) {
                        ...
                        t.emitter.trigger("eventResize", r(r({}, c), { el: n.draggingSegEl, startDelta: n.validMutation.startDelta || kt(0), endDelta: n.validMutation.endDelta || kt(0), jsEvent: e.origEvent, view: t.viewApi })),
    ...
    var Ns = (function () {
        ...
        Os = { dateClick: fn, eventDragStart: fn, eventDragStop: fn, eventDrop: fn, eventResizeStart: fn, eventResizeStop: fn, eventResize: fn, drop: fn, eventReceive: fn, eventLeave: fn },
        As = (function () {
            function e(e, t) {
                var n = this;
                ...
                (t.prototype.renderSimpleLayout = function (e, t) {
                    ...
                    return (
                        ...
                        mo(qo, { viewSpec: r.viewSpec }, function (e, t) {
                            return mo("div", { ref: e, className: ["fc-daygrid"].concat(t).join(" ") }, mo(ja, { liquid: !n.isHeightAuto && !n.forPrint, collapsibleWidth: n.forPrint, cols: [], sections: o }));
                        })
                    );
                }),
    ...
    var Gs = (function (e) {
        ...
        return (
            ...
            (t.prototype.render = function () {
                ...
                return mo(Ka, { date: e.date, dateProfile: e.dateProfile, todayRange: e.todayRange, showDayNumber: e.showDayNumber, extraHookProps: e.extraHookProps, defaultContent: qs }, function (n, o) {
                    return (o || e.forceDayTop) && mo("div", { className: "fc-daygrid-day-top", ref: n }, mo("a", r({ className: "fc-daygrid-day-number" }, t), o || mo(So, null, " ")));
                });
            }),
            t
        );
    ...
    var Xs = (function (e) {
            ...
            return (
                ...
                (t.prototype.render = function () {
                    ...
                    return mo(
                        qa,
                        r({}, e, { extraClassNames: ["fc-daygrid-event", "fc-daygrid-block-event", "fc-h-event"], defaultTimeFormat: Ys, defaultDisplayEventEnd: e.defaultDisplayEventEnd, disableResizing: !e.seg.eventRange.def.allDay })
                    );
                }),
                t
            );
        ...
        Ks = (function (e) {
            ...
            return (
                ...
                (t.prototype.render = function () {
                    ...
                    return mo(
                        Ga,
                        { seg: e.seg, timeText: o, defaultContent: $s, isDragging: e.isDragging, isResizing: !1, isDateSelecting: !1, isSelected: e.isSelected, isPast: e.isPast, isFuture: e.isFuture, isToday: e.isToday },
                        function (t, n, o, i) {
                            return mo("a", r({ className: ["fc-daygrid-event", "fc-daygrid-dot-event"].concat(n).join(" "), ref: t }, ((a = e.seg), (s = a.eventRange.def.url) ? { href: s } : {})), i);
                            var a, s;
                        }
                    );
                }),
    ...
    function $s(e) {
        ...
        return mo(
            ...
            mo("div", { className: "fc-event-seats" }, e.event.extendedProps.bookings +'/' +e.event.extendedProps.total_seats || mo(So, null, " ")),
        );
    }
    var Js = (function (e) {
        function t() {
                                ...
                                n.map(function (n) {
                                    ...
                                    return mo(
                                        ...
                                        Zs(n)
                                            ...
                                            : mo(Xs, r({ seg: n, isDragging: !1, isResizing: !1, isDateSelecting: !1, isSelected: o === e.eventSelection, defaultDisplayEventEnd: !1 }, nr(n, e.todayRange)))
                                    );
                                })
                            );
                        },
        ...
        tl = (function (e) {
            ...
            return (
                ...
                (t.prototype.render = function () {
                    ...
                    return mo(Ja, { date: a, dateProfile: s, todayRange: t.todayRange, showDayNumber: t.showDayNumber, extraHookProps: t.extraHookProps, elRef: this.handleRootEl }, function (e, n, i, u) {
                        return mo(
                            "td",
                            ...
                            mo(
                                ...
                                !u && mo(Gs, { date: a, dateProfile: s, showDayNumber: t.showDayNumber, forceDayTop: t.forceDayTop, todayRange: t.todayRange, extraHookProps: t.extraHookProps }),
                                mo(
                                    "div",
    ...
    function nl(e, t, n, r, o, i, a) {
                    ...
                    for (
                        ...
                        for (var g = 0, m = l; g < m.length; g++) {
                            ...
                            (d += y.levelCoord - c),
                                ...
                                E
                                    ? ((d += y.thickness), S && v.push({ seg: rl(h, y.spanStart, y.spanEnd, n), isVisible: !0, isAbsolute: !0, absoluteTop: y.levelCoord, marginTop: 0 }))
        ...
        for (var b = 0, C = p; b < C.length; b++) {
            ...
            for (D = w.spanStart; D < w.spanEnd; D += 1) (m[D] += 1), h[D].push({ seg: rl(R, D, D + 1, a), isVisible: !1, isAbsolute: !1, absoluteTop: 0, marginTop: 0 });
        }
                ...
                (t.prototype.renderFillSegs = function (e, t) {
                    ...
                    if (a)
                        for (var l = 0, u = e; l < u.length; l++) {
                            ...
                            s.push(mo("div", { key: or(c.eventRange), className: "fc-daygrid-bg-harness", style: d }, "bg-event" === t ? mo(es, r({ seg: c }, nr(c, i))) : Qa(t)));
                        }
                        ...
                        return (
                            ...
                            (t.prototype.buildRenderRange = function (t, n, r) {
                                var o,
                                    ...
                                    s = a.start,
                                    l = a.end;
                                (/^(year|month)$/.test(n) && ((s = i.startOfWeek(s)), (o = i.startOfWeek(l)).valueOf() !== l.valueOf() && (l = Xe(o, 1))), this.props.monthMode && this.props.fixedWeekCount) &&
    ...
    function vl(e) {
        ...
        return mo(_o.Consumer, null, function (n) {
            ...
            return mo(Lo, { hookProps: s, classNames: o.slotLabelClassNames, content: o.slotLabelContent, defaultContent: gl, didMount: o.slotLabelDidMount, willUnmount: o.slotLabelWillUnmount }, function (n, r, o, i) {
                return mo(
                    "td",
                    { ref: n, className: t.concat(r).join(" "), "data-time": e.isoTimeStr },
                    mo("div", { className: "fc-timegrid-slot-label-frame fc-scrollgrid-shrink-frame" }, mo("div", { className: "fc-timegrid-slot-label-cushion fc-scrollgrid-shrink-cushion", ref: o }, i))
                );
            });
        });
    }
            ...
            function t() {
                ...
                return (
                    ...
                    (t.renderTableRowAxis = function (e) {
                        ...
                        return mo(Lo, { hookProps: i, classNames: r.allDayClassNames, content: r.allDayContent, defaultContent: Sl, didMount: r.allDayDidMount, willUnmount: r.allDayWillUnmount }, function (t, n, r, o) {
                            return mo(
                                "td",
                ...
                (t.prototype.renderSimpleLayout = function (e, t, n) {
                    ...
                    return (
                        ...
                        t &&
                            ...
                            i.push({ type: "body", key: "all-day-divider", outerContent: mo("tr", { className: "fc-scrollgrid-section" }, mo("td", { className: "fc-timegrid-divider " + r.theme.getClass("tableCellShaded") })) })),
                        ...
                        mo(qo, { viewSpec: r.viewSpec, elRef: this.rootElRef }, function (e, t) {
                            return mo("div", { className: ["fc-timegrid"].concat(t).join(" "), ref: e }, mo(ja, { liquid: !o.isHeightAuto && !o.forPrint, collapsibleWidth: o.forPrint, cols: [{ width: "shrink" }], sections: i }));
                        })
                    );
                }),
                    ...
                    e &&
                        ...
                        t &&
                            ...
                            f.push({
                                key: "all-day-divider",
                                type: "body",
                                outerContent: mo("tr", { className: "fc-scrollgrid-section" }, mo("td", { colSpan: 2, className: "fc-timegrid-divider " + u.theme.getClass("tableCellShaded") })),
                            }));
                    ...
                    return (
                        ...
                        mo(qo, { viewSpec: u.viewSpec, elRef: this.rootElRef }, function (e, t) {
                            return mo(
                                ...
                                mo(l, { liquid: !c.isHeightAuto && !c.forPrint, collapsibleWidth: !1, colGroups: [{ width: "shrink", cols: [{ width: "shrink" }] }, { cols: [{ span: r, minWidth: o }] }], sections: f })
                            );
                        })
                    );
                }),
                    ...
                    return mo(
                        ...
                        e.slatMetas.map(function (i, a) {
                            ...
                            return mo(
                                ...
                                e.axis && mo(vl, r({}, i)),
                                mo(Lo, { hookProps: s, classNames: n.slotLaneClassNames, content: n.slotLaneContent, didMount: n.slotLaneDidMount, willUnmount: n.slotLaneWillUnmount }, function (e, t, n, r) {
        ...
        Al = (function (e) {
            ...
            return (
                ...
                (t.prototype.render = function () {
                    ...
                    return mo(Ja, { elRef: t.elRef, date: t.date, dateProfile: t.dateProfile, todayRange: t.todayRange, extraHookProps: t.extraHookProps }, function (n, l, u) {
                        return mo(
                            "td",
                            ...
                            mo(
                                ...
                                mo("div", { className: "fc-timegrid-col-bg" }, e.renderFillSegs(t.businessHourSegs, "non-business"), e.renderFillSegs(t.bgEventSegs, "bg-event"), e.renderFillSegs(t.dateSelectionSegs, "highlight")),
                ...
                (t.prototype.renderPositionedFgSegs = function (e, t, n, o, i) {
                    ...
                    return mo(
                        ...
                        y.map(function (s) {
                            ...
                            return mo(
                                "div",
                                { className: "fc-timegrid-event-harness" + (s.stackForward > 0 ? " fc-timegrid-event-harness-inset" : ""), key: c, style: r({ visibility: t[c] ? "hidden" : "" }, d) },
                ...
                (t.prototype.renderHiddenGroups = function (e, t) {
                    ...
                    return mo(
                        ...
                        e.map(function (e) {
                            ...
                            return mo(_l, { key: At(us(f)), hiddenSegs: f, top: p.top, bottom: p.bottom, extraDateSpan: o, dateProfile: i, todayRange: a, nowDate: s, eventSelection: l, eventDrag: u, eventResize: c });
                        })
                    );
                }),
                ...
                (t.prototype.renderFillSegs = function (e, t) {
                    ...
                    var i = this.buildSegInputs(e).map(function (i) {
                        var a = e[i.index];
                        return mo("div", { key: or(a.eventRange), className: "fc-timegrid-bg-harness", style: n.computeSegTopBottomCss(i) }, "bg-event" === t ? mo(es, r({ seg: a }, nr(a, o.todayRange, o.nowDate))) : Qa(t));
                    });
                    return mo(So, null, i);
                }),
    ...
    function Ul(e, t) {
        ...
        return mo(
            ...
            e.map(function (e) {
                ...
                return mo("div", { key: t, style: { visibility: l[t] ? "hidden" : "" } }, mo(Hl, r({ seg: e, isDragging: !1, isResizing: !1, isDateSelecting: !1, isSelected: t === i, isShort: !1 }, nr(e, n, o))));
            })
        );
    }
    var Ll = (function (e) {
        ...
        Xl = (function (e) {
            ...
            return (
                ...
                (t.prototype.render = function () {
                    ...
                    return mo(Lo, { hookProps: f, classNames: s.dayHeaderClassNames, content: s.dayHeaderContent, defaultContent: Kl, didMount: s.dayHeaderDidMount, willUnmount: s.dayHeaderWillUnmount }, function (e, n, r, o) {
                        return mo("tr", { ref: e, className: h.concat(n).join(" "), "data-date": Ut(t) }, mo("th", { colSpan: 3 }, mo("div", { className: "fc-list-day-cushion " + i.getClass("tableCellShaded"), ref: r }, o)));
                    });
                }),
                t
            );
    ...
    function Kl(e) {
        ...
        return mo(So, null, e.text && mo("a", r({ className: "fc-list-day-text" }, t), e.text), e.sideText && mo("a", r({ className: "fc-list-day-side-text" }, t), e.sideText));
    }
                    ...
                    return mo(
                        ...
                        function (e, o, i, a, s) {
                            return mo(
                                ...
                                (function (e, t, n) {
                                    ...
                                    if (!1 !== r.displayEventTime) {
                                        ...
                                        if (
                                            ...
                                            return mo(Lo, { hookProps: l, classNames: r.allDayClassNames, content: r.allDayContent, defaultContent: eu, didMount: r.allDayDidMount, willUnmount: r.allDayWillUnmount }, function (e, t, n, r) {
                                ...
                                mo("td", { className: "fc-list-event-graphic" }, mo("span", { className: "fc-list-event-dot", style: { borderColor: s.borderColor || s.backgroundColor } })),
    ...
    var tu = (function (e) {
        ...
        return (
            ...
            (t.prototype.render = function () {
                ...
                return mo(qo, { viewSpec: n.viewSpec, elRef: this.setRootEl }, function (n, o) {
                    return mo(
                        ...
                        mo(xa, { liquid: !t.isHeightAuto, overflowX: t.isHeightAuto ? "visible" : "hidden", overflowY: t.isHeightAuto ? "visible" : "auto" }, s.length > 0 ? e.renderSegList(s, i) : e.renderEmptyMessage())
                    );
                });
            }),
            (t.prototype.renderEmptyMessage = function () {
                ...
                return mo(Lo, { hookProps: r, classNames: t.noEventsClassNames, content: t.noEventsContent, defaultContent: nu, didMount: t.noEventsDidMount, willUnmount: t.noEventsWillUnmount }, function (e, t, n, r) {
                    ...
                    for (var s = [], l = 0; l < a.length; l += 1) {
                        ...
                        if (u) {
                            ...
                            for (var d = 0, p = (u = Kn(u, i.eventOrder)); d < p.length; d++) {
                                var f = p[d];
                                s.push(mo(Jl, r({ key: c + ":" + f.eventRange.instance.instanceId, seg: f, isDragging: !1, isResizing: !1, isDateSelecting: !1, isSelected: !1 }, nr(f, n, e))));
                            }
                        }
                    }
    ...
    (au.prototype.classes = {
        ...
        (au.prototype.iconClasses = { close: "fa-times", prev: "fa-chevron-left", next: "fa-chevron-right", prevYear: "fa-angle-double-left", nextYear: "fa-angle-double-right" }),
    ...
    return (
        ...
        (e.formatRange = function (e, t, n) {
            ...
            return i && a ? r.formatRange(i.marker, a.marker, o, { forcedStartTzo: i.forcedTzo, forcedEndTzo: a.forcedTzo, isEndExclusive: n.isEndExclusive, defaultSeparator: on.defaultRangeSeparator }) : "";
        }),
