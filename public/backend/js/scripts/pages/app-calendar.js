...
document.addEventListener('DOMContentLoaded', function () {
  var calendarEl = document.getElementById('calendar'),
    ...
    eventTitle = $('#title'),
    eventUsers = $('#all_users'),
    eventBookings =$('#bookings'),
    eventSeats =$('#total_seats'),
    eventStartTime =$('#time_start'),
    eventEndTime =$('#time_end'),
  ...
  function eventClick(info) {
    ...
    const usersArray =eventToUpdate.extendedProps.users
    const usersString = usersArray.join('<br>');
    eventUsers.html(usersString);
    eventBookings.text(eventToUpdate.extendedProps.bookings);
    eventSeats.text(eventToUpdate.extendedProps.total_seats);
    eventStartTime.val(eventToUpdate.extendedProps.start_time);
    eventEndTime.val(eventToUpdate.extendedProps.end_time);
